...
function demo0() {
    const stortTall = Number.MAX_SAFE_INTEGER;
    const veldigStortTallBig = BigInt(stortTall) ** 3n;

    console.log(`${typeof veldigStortTallBig} har verdi ${veldigStortTallBig}`);
}

function demo1() {
    const veldigStortTallNumber = 93 ** 12376;
    const veldigStortTallBigInt = 93n ** 12376n;

    console.log(`${typeof veldigStortTallNumber} har verdi ${veldigStortTallNumber}`);
    console.log(`${typeof veldigStortTallBigInt} har verdi ${veldigStortTallBigInt}`);
}
